...
const NotFound: React.FC = function (){
    ...
    return (
        <div style={{width: "100%", height: "100%"}}>
            <div id="retrobg" className={shutdown?"retrobg-shutdown":""}>
                <div id="retrobg-sky">
                    ...
                    <div id="retrobg-sunWrap">
                        <div style={{zIndex:"100", color:"white",  position: "relative", marginBottom: "-25%"
                        }}>
                            <span style={{
                                position:"absolute",
                                top: "0%",
                        ...
                        <div id="retrobg-sun" onClick={()=>toggleShutdown(current=> !current)}>
