...
const OverlayYesNoDeleteCollection: React.FC<OverlayYesNoProps> = ({continueCallback, isInvisible=false}: OverlayYesNoProps)=>{
        ...
        <div className={invisible?"invisible":"overlay"}>
            <div className="card halfable-margin overlay-content" style={{zIndex: 6, position: "absolute",color: "black"}}>
                ...
                <span className="full-margin">
                  ¿Seguro que quieres borrar está colección? Se borrará junto a todos sus coleccionables.
                </span>
                </div>
                <div className="flex-col full-margin">
...
export default OverlayYesNoDeleteCollection;