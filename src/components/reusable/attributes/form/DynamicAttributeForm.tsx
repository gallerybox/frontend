...
function DynamicAttributeForm({tag, value, category, representation, representationOrder, showTag, updateValue, className=""}: DynamicAttributeFormProps){
    ...
    return (
        <div className={"Input " + wayToShow +className} style={{order: representationOrder}}>
            ...
            <div className={"margin "+ width}>
                <Input value={value} tag={tag} updateValue={updateValue} representation={representation}/>
            </div>
        </div>
    );
}
